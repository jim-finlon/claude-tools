#!/bin/bash
# Claude Code WSL Setup - Tool Installation Script
# Run with: bash install-claude-tools.sh

set -e  # Exit on error

echo "=========================================="
echo "Claude Code WSL Tool Installation"
echo "=========================================="
...
# Claude Code aliases
alias writing='cd /mnt/d/Obsidian_Shared/Writing'
alias research='cd /mnt/d/Obsidian_Shared/Research'
alias craft='cd /mnt/d/Obsidian_Shared/Writing/The-Craft-of-Fiction'
alias aiwrite='cd /mnt/d/Obsidian_Shared/Writing/AI-Writing-Assistant'
...
echo "  research  - cd to Research folder"
echo "  craft     - cd to The-Craft-of-Fiction"
echo "  aiwrite   - cd to AI-Writing-Assistant"
